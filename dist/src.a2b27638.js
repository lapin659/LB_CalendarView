...
},{}],"../rbd/pnpm-volume/7643b825-854f-4999-b646-bc0857497c7c/node_modules/.registry.npmjs.org/parcel-bundler/1.12.5/node_modules/parcel-bundler/src/builtins/bundle-url.js":[function(require,module,exports) {
var bundleURL = null;
...
},{}],"../rbd/pnpm-volume/7643b825-854f-4999-b646-bc0857497c7c/node_modules/.registry.npmjs.org/parcel-bundler/1.12.5/node_modules/parcel-bundler/src/builtins/css-loader.js":[function(require,module,exports) {
...
},{"./bundle-url":"../rbd/pnpm-volume/7643b825-854f-4999-b646-bc0857497c7c/node_modules/.registry.npmjs.org/parcel-bundler/1.12.5/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"src/styles.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"_css_loader":"../rbd/pnpm-volume/7643b825-854f-4999-b646-bc0857497c7c/node_modules/.registry.npmjs.org/parcel-bundler/1.12.5/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"node_modules/dayjs/plugin/weekday.js":[function(require,module,exports) {
var define;
...
var INITIAL_MONTH = (0, _dayjs.default)().format("M");
...
function createCalendar() {
  var year = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : INITIAL_YEAR;
  var month = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : INITIAL_MONTH;
  ...
  currentMonthDays = createDaysForCurrentMonth(year, month, (0, _dayjs.default)("".concat(year, "-").concat(month, "-01")).daysInMonth());
...
function removeAllDayElements(calendarDaysElement) {
  var first = calendarDaysElement.firstElementChild;
...
function getNumberOfDaysInMonth(year, month) {
  return (0, _dayjs.default)("".concat(year, "-").concat(month, "-01")).daysInMonth();
}

function createDaysForCurrentMonth(year, month) {
  return _toConsumableArray(Array(getNumberOfDaysInMonth(year, month))).map(function (day, index) {
    return {
      date: (0, _dayjs.default)("".concat(year, "-").concat(month, "-").concat(index + 1)).format("YYYY-MM-DD"),
      dayOfMonth: index + 1,
      isCurrentMonth: true
    };
  });
...
function createDaysForPreviousMonth(year, month) {
  ...
  var previousMonth = (0, _dayjs.default)("".concat(year, "-").concat(month, "-01")).subtract(1, "month"); // Cover first day of the month being sunday (firstDayOfTheMonthWeekday === 0)

  var visibleNumberOfDaysFromPreviousMonth = firstDayOfTheMonthWeekday ? firstDayOfTheMonthWeekday - 1 : 6;
  var previousMonthLastMondayDayOfMonth = (0, _dayjs.default)(currentMonthDays[0].date).subtract(visibleNumberOfDaysFromPreviousMonth, "day").date();
  return _toConsumableArray(Array(visibleNumberOfDaysFromPreviousMonth)).map(function (day, index) {
    return {
      date: (0, _dayjs.default)("".concat(previousMonth.year(), "-").concat(previousMonth.month() + 1, "-").concat(previousMonthLastMondayDayOfMonth + index)).format("YYYY-MM-DD"),
...
function createDaysForNextMonth(year, month) {
  var lastDayOfTheMonthWeekday = getWeekday("".concat(year, "-").concat(month, "-").concat(currentMonthDays.length));
  var nextMonth = (0, _dayjs.default)("".concat(year, "-").concat(month, "-01")).add(1, "month");
  ...
  return _toConsumableArray(Array(visibleNumberOfDaysFromNextMonth)).map(function (day, index) {
    return {
      date: (0, _dayjs.default)("".concat(nextMonth.year(), "-").concat(nextMonth.month() + 1, "-").concat(index + 1)).format("YYYY-MM-DD"),
      dayOfMonth: index + 1,
      isCurrentMonth: false
    };
  });
...
},{"dayjs":"node_modules/dayjs/dayjs.min.js","./styles.css":"src/styles.css","dayjs/plugin/weekday":"node_modules/dayjs/plugin/weekday.js","dayjs/plugin/weekOfYear":"node_modules/dayjs/plugin/weekOfYear.js"}],"../rbd/pnpm-volume/160647e4-320a-4c0a-92e7-a3e3eec3abba/node_modules/.registry.npmjs.org/parcel-bundler/1.12.5/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "34912" + '/');
...
},{}]},{},["../rbd/pnpm-volume/160647e4-320a-4c0a-92e7-a3e3eec3abba/node_modules/.registry.npmjs.org/parcel-bundler/1.12.5/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","src/index.js"], null)
